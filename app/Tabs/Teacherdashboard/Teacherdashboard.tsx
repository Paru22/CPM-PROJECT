...
const ManageTeachers = () => {
  ...
  const fetchTeachers = useCallback(async () => {
    ...
    try {
      ...
      // Filter out inactive teachers from the list
      const activeTeachers = teachersList.filter(teacher => teacher.isActive !== false);
      
      setTeachers(activeTeachers);
      applyFilters(activeTeachers, searchQuery, selectedRole);
    } catch (error) {
  ...
  // UPDATED: Delete teacher by deactivating (prevents login)
  const handleDeleteTeacher = async () => {
    if (!teacherToDelete) return;

    Alert.alert(
      "Delete Teacher",
      `Are you sure you want to delete ${teacherToDelete.name}?\n\nThis teacher will no longer be able to log in to the app.`,
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Delete",
          ...
          onPress: async () => {
            ...
            try {
              ...
              // Optionally delete subject assignments
              ...
              Alert.alert("Success", `${teacherToDelete.name} has been deleted and cannot log in anymore.`);
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.confirmModal, { backgroundColor: colors.card }]}>
            ...
            <View style={styles.confirmButtons}>
              ...
              >
                <Text style={styles.deleteConfirmText}>Delete Teacher</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
